...
namespace Sulaeman\SocialLogin\Provider\Thirdparty;
 ...
 */
class Facebook extends \Hybrid_Provider_Model {
    ...
    function loginBegin() {
        ...
        // Add display type if defined
        if (isset($this->config['display'])) {
            $url .= '&display='.$this->config['display'];
        }
